        ...
        try {
            ...
            if ($this->fill($requestData)->save()) {
                ...
                foreach ($fields as $field) {
                    ...
                    foreach (['browse', 'read', 'edit', 'add', 'delete', 'search'] as $check) {
                    ...
                    $dataRow->additional_details =  !empty($requestData['field_additional_details_'.$field]) ? json_decode($requestData['field_additional_details_'.$field]) : json_decode('{}');
        ...
        if (isset($requestData['relationships'])) {
            ...
            if (count($relationships) > 0) {
                foreach ($relationships as $index => $relationship) {
                    ...
                    /*$requestData['field_additional_details_'.$relationship] = !empty($requestData['field_additional_details_' . $relationship])  ? $requestData['field_additional_details_' . $relationship] : "{}";*/
                }
            }
        }
