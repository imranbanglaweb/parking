                ...
                <div class="page-content settings container-fluid">
                    <ul class="nav nav-tabs">
                        @foreach($settings as $group => $setting)
                            <li class="nav-item">
                                <a data-toggle="tab" class="nav-link {{$group == $active ? 'active':''}}" href="#{{ \Illuminate\Support\Str::slug($group) }}">{{ $group }}</a>
                            </li>
                        @endforeach
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="{{ \Illuminate\Support\Str::slug($group) }}" class="tab-pane fade in @if($group == $active) active show @endif">
...
@section('javascript')
    <script type="text/javascript" src="{{ asset('/public/backend_resources/js/form-with-editor.js') }}"></script>
    <script>
