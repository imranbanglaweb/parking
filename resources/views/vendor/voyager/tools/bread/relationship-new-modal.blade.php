...
<form role="form" action="{{ route('voyager.bread.relationship') }}" method="POST">
    <div class="modal fade modal-danger modal-relationships" id="new_relationship_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModal3Label" aria-hidden="true">
        <div class="modal-dialog modal-lg relationship-panel">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">{{ \Illuminate\Support\Str::singular(ucfirst($table)) }} {{ __('voyager::database.relationship.relationships') }}</h6>
