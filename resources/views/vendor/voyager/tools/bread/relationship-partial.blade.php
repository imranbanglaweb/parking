...
<div class="row row-dd row-dd-relationship">
    ...
    <div class="col-md-12 voyager-relationship-details">
        ...
        <!-- added by kalyan additional field start -->
        <div class="col-sm-4">
            <div class="alert alert-danger validation-error">
                {{ __('voyager::json.invalid') }}
            </div>
            <textarea id="json-input-{{$relationship['field']}}" class="resizable-editor" data-editor="json" name="field_additional_details_{{ $relationship['field'] }}">

                    @if(isset($relationship->additional_details))
                    {{ json_encode($relationship->additional_details) }}
                @else
                    {}
                @endif
            </textarea>
