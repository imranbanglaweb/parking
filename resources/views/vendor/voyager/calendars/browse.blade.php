        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-eye"></i>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <table class="table borderless">
                            <tr>
                                <td style=" border: none;"><p class="font-weight-bold">{{__('Event Title')}} </p></td>
                                <td style=" border: none;">: <span id="event_title_edit"> </span></td>
                            </tr>
                            <tr>
                                <td style=" border: none;"><p class="font-weight-bold">{{__('Event Start Date')}} </p></td>
                                <td style=" border: none;">: <span id="event_date_start"></span></td>
                            </tr>
                            <tr>
                                <td style=" border: none;"><p class="font-weight-bold">{{__('Event End Date')}} </p></td>
                                <td style=" border: none;">: <span id="event_date_end"></span></td>
                            </tr>
                            <tr>
                                <td style=" border: none;"><p class="font-weight-bold">{{__('Event Details')}} </p></td>
                                <td style=" border: none;">: <span id="event_details_edit"></span></td>
                            </tr>
                            <tr>
                                <td style=" border: none;"><p class="font-weight-bold">{{__('Event Type')}}</p></td>
                                <td style=" border: none;">
                                    <select name="event_type" id="event_type_edit" class="form-control text-uppercase bg-transparent" disabled>
                                        <option value="">Select Option</option>
                                        @foreach($type as $typ)
                                            <option value="{{$typ}}">{{implode(' ', explode('_', $typ))}}</option>
                                        @endforeach
                                    </select>
                                </td>
                            </tr>
...
@section('javascript')
    ...
    <script type="text/javascript" src="{{ url('public/backend_resources/js/jquery_validation_combine.js') }}"></script>
    <script>
        ...
        $(document).ready(function() {
            ...
            var calendar = $('#calendar').fullCalendar({
                ...
                eventClick:function(event)
                {
                    ...
                    $('#event_title_edit').text(event.title);
                    $('#event_details_edit').text(event.description);
                    $('#event_type_edit').val(event.type);
                    $('#event_date_start').text(event.start.format());
                    event.end.subtract(1, 'days')
                    $('#event_date_end').text(event.end.format());
