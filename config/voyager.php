...
return [
    ...
    /*   'assets_path' => 'resources/voyager/assets', */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['migrations', 'data_rows', 'data_types', 'menu_items', 'password_resets', 'permission_role', 'settings', 'pages', 'posts', 'categories'],
        ],
