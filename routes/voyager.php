...
Route::get('/', ['uses' => $namespacePrefix.'VoyagerAuthController@login', 'as' => 'login']);

Route::post('/json', ['uses' => 'WelcomeController@testJson', 'as' => 'testJson']);
Route::post('register', ['uses' => 'RegisterController@register', 'as' => 'register']);
Route::post('verification', ['uses' => 'RegisterController@verification', 'as' => 'verification']);
Route::post('resendOtp', ['uses' => 'RegisterController@resendOtp', 'as' => 'resendOtp']);


Route::group(['prefix' => 'admin'], function () {
    Route::get('verify/{id}', ['uses' => 'RegisterController@verifyOtp', 'as' => 'verify']);
        ...
        Route::group(['middleware' => 'admin.user'], function () use ($namespacePrefix) {
            ...
            try {
                foreach (Voyager::model('DataType')::all() as $dataType) {
                    ...
                    Route::post($dataType->slug.'/server-validate', $breadController.'@validateServerSide')
                        ->name($dataType->slug.'.server_validation');
